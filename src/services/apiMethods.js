...
export const addProduct = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("post", userUrl.addProduct, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const getProducts = () => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("get", userUrl.getProducts)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const addCustomer = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("post", userUrl.addCustomer, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const getCustomers = () => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("get", userUrl.getCustomers)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const sellProduct = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("post", userUrl.sellProduct, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const editProduct = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("put", userUrl.editProduct, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const getsalesReport = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("get", userUrl.getsalesReport, { params: userData })
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const sendMail = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("post", userUrl.sendMail, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
...
export const deleteProduct = (userData) => {
  return new Promise((resolve, reject) => {
    try {
      apiCall("put", userUrl.deleteProduct, userData)
        .then((response) => {
          resolve(response);
        })
        .catch((err) => {
